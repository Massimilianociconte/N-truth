...
def test_preclinie_paper_grouping():
    doc_ids = ["my_pdf1_title", "my_pdf1_abstract", "my_pdf1_methods", "my_pdf2_title", "my_pdf2_abstract"]
    ...
    assert split_map[preclinie_group_id("my_pdf1_title")] == split_map[preclinie_group_id("my_pdf1_abstract")]
    assert split_map[preclinie_group_id("my_pdf1_abstract")] == split_map[preclinie_group_id("my_pdf1_methods")]
