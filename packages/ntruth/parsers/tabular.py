...
class CsvParser:
    ...
    def parse(self, path: Path) -> RawDocument:
        ...
        # Il contratto per .csv e il separatore virgola: lo sniffing resta solo
        # per estensioni non ambigue, perche la prosa puo flippare il delimiter
        # rilevato e spezzare le righe a meta pipeline.
